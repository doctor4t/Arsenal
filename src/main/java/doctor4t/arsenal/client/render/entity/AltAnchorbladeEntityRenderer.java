...
public class AltAnchorbladeEntityRenderer extends EntityRenderer<AnchorbladeEntity> {
	...
	public AltAnchorbladeEntityRenderer(EntityRendererFactory.Context ctx) {
		super(ctx);
