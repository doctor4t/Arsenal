...
public class ScytheDynamicItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    public static final ModelIdentifier WEAPON = new ModelIdentifier(Arsenal.id("scythe_inventory"), "inventory");
    public static final ModelIdentifier WEAPON_IN_HAND = new ModelIdentifier(Arsenal.id("scythe_in_hand"), "inventory");
